...
class LazySearchAdimssHerCostBounded : public SearchEngine {
protected:
...
public:
    explicit LazySearchAdimssHerCostBounded(const options::Options &opts);
    virtual ~LazySearchAdimssHerCostBounded() = default;
