#ifndef FIRST_FIT_DECREASING_BIN_PACKER_H
#define FIRST_FIT_DECREASING_BIN_PACKER_H
...
namespace pdbs {
    ...
    class FirstFitDecreasingBinPacker : public BinPacker {
    ...
    public:
        FirstFitDecreasingBinPacker(double pdb_size, int num_collections);
        ~FirstFitDecreasingBinPacker() {}
